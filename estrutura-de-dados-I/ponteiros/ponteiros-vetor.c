...
int main(){
    ...
    int i, *p;
    p = vetor;  // atribui o endereço do primeiro elemento do vetor à variável p
    
      // 'p' agora aponta para o primeiro elemento do vetor, então usamos *p para acessar o valor nele.
